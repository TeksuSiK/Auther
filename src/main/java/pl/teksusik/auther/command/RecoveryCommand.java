...
public class RecoveryCommand implements CommandExecutor {
    ...
    public RecoveryCommand(AccountService accountService, SessionService sessionService, MessageService messageService, MessageConfiguration messageConfiguration) {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        this.sessionService.verifyScratch(player.getUniqueId(), code);
        return true;
    }
}
